...
import banner1 from '../../../img/carosol/pexels-photo-1149137.jpeg'
import banner2 from '../../../img/carosol/img-2222.jpeg'
import banner3 from '../../../img/carosol/img-3333333.jpeg'
  ...
  <div className="carousel-inner ">
    <div className="carousel-item active text-white" data-bs-interval="10000">
      ...
      <div className="carousel-caption  text-center ">
        <h2 className="">WELCOME TO CAR HOUSE </h2>
            <p className="para">“Car House” has been a strong seller of brand new vehicles.</p>
            <button className="btn btn-dark text-white mx-2 mb-2">GET STARTED NOW → </button>
            <button className="btn btn btn-dark text-white "> LEARN MORE </button>
      </div>
    </div>
    <div className="carousel-item" data-bs-interval="2000">
      ...
      <div className="carousel-caption d-none d-md-block">
        <h2>FIND YOUR DREAM CAR</h2>
            ...
            <button className="btn btn-dark text-white mx-3">GET STARTED NOW → </button>
            <button className="btn btn btn-dark text-white "> LEARN MORE </button>
      </div>
    </div>
